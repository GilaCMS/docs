...
<head>
  ...
  <title>Welcome to Gila CMS’s documentation! &mdash; Gila CMS 24 Nov 2017 documentation</title>
    ...
    <link rel="stylesheet" href="_static/css/theme.css" type="text/css" />
        ...
        <link rel="author" title="About these documents"
              href="about.php"/>
    <link rel="top" title="Gila CMS 24 Nov 2017 documentation" href="#"/>
        <link rel="next" title="About" href="about.php"/>
    ...
    <nav data-toggle="wy-nav-shift" class="wy-nav-side">
      <div class="wy-side-scroll">
        <div class="wy-side-nav-search">
            ...
            <a href="#" class="icon icon-home"> Gila CMS
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Welcome to Gila CMS&#8217;s documentation!</li>
  ...
  <div class="section" id="welcome-to-gila-cms-s-documentation">
<h1>Welcome to Gila CMS&#8217;s documentation!<a class="headerlink" href="#welcome-to-gila-cms-s-documentation" title="Permalink to this headline">¶</a></h1>
<p>Contents:</p>
<div class="toctree-wrapper compound" id="user-manual">
<p class="caption"><span class="caption-text">User Manual</span><a class="headerlink" href="#user-manual" title="Permalink to this toctree">¶</a></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="about.php">About</a><ul>
<li class="toctree-l2"><a class="reference internal" href="about.php#why-choose-gila">Why choose Gila?</a></li>
<li class="toctree-l2"><a class="reference internal" href="about.php#spreading-the-word">Spreading the word!</a></li>
...
<div class="toctree-wrapper compound" id="programmers-guide">
<p class="caption"><span class="caption-text">Programmers Guide</span><a class="headerlink" href="#programmers-guide" title="Permalink to this toctree">¶</a></p>
<ul>
<li class="toctree-l1"><a class="reference internal" href="structure.php">Structure</a><ul>
<li class="toctree-l2"><a class="reference internal" href="structure.php#packages">Packages</a></li>
</ul>
...
<li><a class="reference internal" href="genindex.php"><span>Index</span></a></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="about.php" class="btn btn-neutral float-right" title="About" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
